			...
			case R.id.bNew:
				...
				builder.setItems(levels, new DialogInterface.OnClickListener() {
				    public void onClick(DialogInterface dialog, int item) {
				    	Intent game = new Intent(Menu.this, org.luzai.Game.class);  //create an Intent to launch the Game Activity
						org.luzai.Maze maze = org.luzai.MazeCreator.getMaze(item+1);    //use helper class for creating the Maze
